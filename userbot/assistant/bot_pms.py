    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**👋 ʜᴇʟʟᴏ {mention}**\
                        \n\n**I ᴀᴍ [ɢᴛ ᠰ ɴᴇʀᴏ](https://t.me/GTNero) ᴀssɪsᴛᴀɴᴛ ʙᴏᴛ**\
                        \n**Iғ ʏᴏᴜ ɴᴇᴇᴅ ᴀɴʏ ʜᴇʟᴘ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ғᴏʀ ɪᴛ ʜᴇʀᴇ**\
                        \n**[ɢᴛ ᠰ ɴᴇʀᴏ](https://t.me/GTNero) ᴡɪʟʟ ʀᴇᴘʟʏ ᴛᴏ ʏᴏᴜ ᴠɪᴀ ᴛʜɪs ʙᴏᴛ ᴡʜᴇɴ ɪᴛ ᴄᴏᴍᴇs ᴏɴʟɪɴᴇ**\
                        \n\n**Я помощник бота [ɢᴛ ᠰ ɴᴇʀᴏ](https://t.me/GTNero)**\
                        \n**Если вам нужна помощь, вы можете попросить об этом здесь**\
                        \n**[ɢᴛ ᠰ ɴᴇʀᴏ](https://t.me/GTNero) ответит вам через этого бота, когда он появится в сети**"
        buttons = [
            (
