...
async def bot_start(event):
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            ...
            start_msg = f"**👋 ʜᴇʟʟᴏ {mention}**\
                        \n\n**I ᴀᴍ [ɢx ᡧ ɴᴇᴏ](https://t.me/Gxneo) ᴀssɪsᴛᴀɴᴛ ʙᴏᴛ**\
                        \n**Iғ ʏᴏᴜ ɴᴇᴇᴅ ᴀɴʏ ʜᴇʟᴘ ʏᴏᴜ ᴄᴀɴ ᴀsᴋ ғᴏʀ ɪᴛ ʜᴇʀᴇ**\
                        \n**[ɢx ᡧ ɴᴇᴏ](https://t.me/Gxneo) ᴡɪʟʟ ʀᴇᴘʟʏ ᴛᴏ ʏᴏᴜ ᴠɪᴀ ᴛʜɪs ʙᴏᴛ ᴡʜᴇɴ ɪᴛ ᴄᴏᴍᴇs ᴏɴʟɪɴᴇ**\
                        \n\n**Я помощник бота [ɢx ᡧ ɴᴇᴏ](https://t.me/Gxneoo)**\
                        \n**Если вам нужна помощь, вы можете попросить об этом здесь**\
                        \n**[ɢx ᡧ ɴᴇᴏ](https://t.me/Gxneo) ответит вам через этого бота, когда он появится в сети**"
        buttons = [
            (
                Button.url("🍁 ᴊᴏɪɴ ᴏᴜʀ ᴍᴏᴠɪᴇ ɢʀᴏᴜᴘ 🍁", "https://t.me/Cinemabranthen",
                ),
            )
        ]
    else:
